...
public class TestMicroprofileConfigServiceShould {
    ...
    @BeforeEach
    public void setup_config_service() {
        microprofileConfigService = new MicroprofileConfigService();
    }

    @Test
    public void get_correct_ms_token_uri() {
    ...
    @Test
    public void set_correct_proxy_host_and_port() {
    ...
    @Test
    public void error_if_private_key_file_does_not_end_with_der() {
    ...
    @Test
    public void error_if_public_key_file_does_not_end_with_cer() {
        Exception exception = assertThrows(Exception.class, () -> {
