...
For feature requests, **please reach out by email** to **api at morganstanley dot com**. Alternatively, reach out to your Morgan Stanley contact.

Before contributing to this repository yourself, please first **discuss the change you wish to make** with the owners of this repository via email.
...
* Update the README.md/docs with details of changes to the interface or setup instructions.
